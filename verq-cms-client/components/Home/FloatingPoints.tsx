...
import { FloatingPointsSection } from '@/service/fetchHomePage';
...
const FloatingPoints = ({ data }: { data: FloatingPointsSection | null }) => {
  if (!data) return null;
          ...
          {points.map((point, index) => (
            <div
              ...
              className="absolute border border-primary/50 rounded-full
                ...
                text-primary flex items-center justify-center font-family-inter
