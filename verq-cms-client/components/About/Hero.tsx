...
import { AboutPageHero } from "@/service/fetchAboutPage";
...
const INPUT_PLACEHOLDER = "Enter Your Email";
const BUTTON_TEXT = "JOIN IN";

export default function Hero({ data }: { data: AboutPageHero }) {
    ...
    <ContainerLayout>
      ...
      >
        ...
        <div className="relative z-20 h-full flex flex-col justify-end lg:pb-5 md:pb-30 pb-19 px-4 lg:px-8">
          ...
          <p
            ref={subtitleRef}
            className="text-md md:text-lg lg:text-[20px] font-family-inter text-[#e0e0e0] md:mt-3 mt-1 md:max-w-md lg:max-w-sm max-w-[270px] font-light md:tracking-wide opacity-90"
          >
            {data.Desc}
          </p>
